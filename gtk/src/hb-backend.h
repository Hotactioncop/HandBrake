...
void ghb_backend_scan(const char *path, int titleindex, int preview_count, uint64_t min_duration, uint64_t max_duration, int hw_decoder, gboolean keep_duplicate_titles);
void ghb_backend_scan_list(GListModel *files, int titleindex, int preview_count, uint64_t min_duration, uint64_t max_duration, int hw_decoder, gboolean keep_duplicate_titles);
